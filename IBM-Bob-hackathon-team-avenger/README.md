...
| Today Hub | Recall Search | Debugging Helper |
|---|---|---|
| ![Today Hub](assets/screenshots/01-today-hub.png) | ![Recall Search](assets/screenshots/02-recall-search.png) | ![Debugging Helper](assets/screenshots/03-debugging-helper.png) |

| Daily Report | In-Session Analytics | Idea Mapper |
|---|---|---|
| ![Daily Report](assets/screenshots/04-daily-report.png) | ![Analytics](assets/screenshots/05-in-session-analytics.png) | ![Ideas](assets/screenshots/06-idea-mapper.png) |

| Developer Identity | GitHub Activity | Touch Grass Wellness |
|---|---|---|
| ![Identity](assets/screenshots/07-developer-identity-graph.png) | ![GitHub](assets/screenshots/08-github-activity.png) | ![Wellness](assets/screenshots/09-touch-grass-wellness.png) |

See [`assets/screenshots/`](assets/screenshots/) for all 14 UI screenshots and [`assets/bob-screenshots/`](assets/bob-screenshots/) for Bob integration screenshots.

## Demo video

See [`assets/DEMO_VIDEO.txt`](assets/DEMO_VIDEO.txt) for the public URL and scene breakdown.
Place `assets/demo.mp4` here once recorded (see [`docs/DEMO_RECORDING.md`](docs/DEMO_RECORDING.md)).

## Docs

- [`docs/PROBLEM_AND_SOLUTION.md`](docs/PROBLEM_AND_SOLUTION.md) — 500-word problem & solution statement
- [`docs/TECHNOLOGY_STATEMENT.md`](docs/TECHNOLOGY_STATEMENT.md) — Bob + watsonx.ai writeup
...
- [`docs/technical_report.md`](docs/technical_report.md) — technical write-up (source for `technical_report.pdf`)
- [`docs/LICENSE_AUDIT.md`](docs/LICENSE_AUDIT.md) — third-party license audit
- [`docs/CONTRACTS.md`](docs/CONTRACTS.md) — API + schema contracts
...
- [`docs/security/`](docs/security/) — threat model, security guidelines, remediation plan
